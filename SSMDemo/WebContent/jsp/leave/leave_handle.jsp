...
<form id="leaveForm" action="" method="POST" target="_parent">
    <input type="hidden" name="id" value="${ leave.id }"/>
	<div id="base" class="box clear box-news-pad">
      <div class="box-header clear">
        <ul class="add-p">
          <li><span>姓名</span><input type="text" id="cname" name="cname"
                       value="${leave.cname}"/></li>
          <li><span>离院时间</span><input type="text" id="leavedate" name="leavedate"
                       value="${leave.leavedate}"/></li>
        </ul>
        <ul class="add-p">
          <li><span>接院人</span><input type="text" id="carrypeople" name="carrypeople"
                          value='${leave.carrypeople }'/>
          </li>
        </ul>
         <ul class="add-a">
          <li><span>备注</span>
