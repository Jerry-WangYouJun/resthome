...
<div class="main">
    <form action="${basePath}/bed/query" method="POST" id="bedListForm">
        ...
        <div class="main-right">
            <div class="content">
            	<p class="content-top">
						<span>床位</span><input type="text" id = "code"  name="code" value= "${bed.code}"/>
						<span>房间</span><input type="text" id = "room"  name="room" value= "${bed.room}"/>
						<span>院区</span><input type="text" id = "area"  name="area" value= "${bed.area}"/>
